...
try
    ...
    meta.inputs = struct( ...
        ...
        'nSeg', nSeg, ...
        'nShotOff', nShotOff, ...
        'nMeasuresPerShot', nMeasuresPerShot, ...
        'nExcludeMeasures', nExcludeMeasures, ...
        'nLines', nLines, ...
        'costTime', costTime ...
    );
    meta.algorithm = struct( ...
        'exclude_non_steady_state', true, ...
        'exclude_si_projection_every_n_measures', nMeasuresPerShot ...
    );
    meta.output_file = saveName;
...
try
    ...
    meta.algorithm = struct( ...
        'temporalWindowSec', temporalWindowSec, ...
        ...
        'nMasks', nMasks, ...
        'exclude_non_steady_state', true, ...
        'exclude_si_projection_every_n_measures', nSeg ...
    );
    meta.output_file = saveName;
