...
try
    ...
    meta.inputs = struct( ...
        'body_coil_file', bodyCoilFile, ...
        'head_coil_file', headCoilFile, ...
        'traj_type', headCoilReader.acquisitionParams.traj_type, ...
        'n_shot_off', nShotOff ...
    );
    meta.reconstruction = struct( ...
        'grid_size_N_u', N_u, ...
        'dK_u', dK_u, ...
        'n_iter_secondary', nIter, ...
        'mask_method', 'bmCoilSense_nonCart_mask_automatic' ...
    );
