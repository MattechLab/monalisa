...
%   sensitivity profiles with the recorded data and summing all coils
%   together, normalizing with the contribution from the different coils.
%   This comes from x0 = C * x -> x = (C*) * x0 with C* being the
%   conjugate.
...
% Reconstructing the image by summing and normalizing the data acquired
% with a pseudoinverse multiplication of the coil data.
